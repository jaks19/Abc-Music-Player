//Source: Code obtained from available 6.005 sample code

package abc.sound.ClassCodeUsed;
...
public class Pitch {
    ...
    //   
    //   If a pitch has a natural accidental in the abc music, boolean natural is true
    //   
    // Representation invariant: true
    //
    // Safety from representation exposure:
    // - Fields private and final
    // - Returned types are immutable: integer, String, Boolean, Pitch
    ...
    /**
     * @return the natural field state of the pitch
     */
